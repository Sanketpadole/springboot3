...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2).apiInfo((ApiInfo) getInfo()).securityContexts(securityContexts())
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : Backened Course",
				"This project is developed bby Learn Code with Durgesh", "1.0", "Terms of Service",
				new Contact(" ", " ", " "), "License of APIS", "API license URL", Collections.emptyList());
